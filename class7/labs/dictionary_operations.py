...
person = {"firstname":"Jon","lastname":"Alicea","fav_food":"pizza","eyecolor":"brown","teeth":">9000"}
...
print "%s has %s teeth" % (person['firstname'],person["teeth"])
# change your favorite food
person["fav_food"] = "rice"
